...
import AllVenueIntelligence from './views/all-venue-intelligence'
...
import UnlockedIntelligence from './views/unlocked-intelligence'
  ...
  return (
    <Router>
      <Switch>
        ...
        <Route
          component={AllVenueIntelligence}
          exact
          path="/all-venue-intelligence"
        />
        <Route
        ...
        <Route
          component={UnlockedIntelligence}
          exact
          path="/unlocked-intelligence"
        />
